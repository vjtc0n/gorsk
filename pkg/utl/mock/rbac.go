...
type RBAC struct {
	...
	EnforceRoleFn     func(echo.Context, veep.AccessRole) error
	...
	AccountCreateFn   func(echo.Context, veep.AccessRole, int, int) error
	IsLowerRoleFn     func(echo.Context, veep.AccessRole) error
}

// User mock
func (a *RBAC) User(c echo.Context) *veep.AuthUser {
	return a.UserFn(c)
}

// EnforceRole mock
func (a *RBAC) EnforceRole(c echo.Context, role veep.AccessRole) error {
...
// AccountCreate mock
func (a *RBAC) AccountCreate(c echo.Context, roleID veep.AccessRole, companyID, locationID int) error {
	return a.AccountCreateFn(c, roleID, companyID, locationID)
}

// IsLowerRole mock
func (a *RBAC) IsLowerRole(c echo.Context, role veep.AccessRole) error {
