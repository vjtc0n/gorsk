...
type createReq struct {
	...
	RoleID     veep.AccessRole `json:"role_id" validate:"required"`
}
...
func (h *HTTP) create(c echo.Context) error {
	...
	if r.RoleID < veep.SuperAdminRole || r.RoleID > veep.UserRole {
		return veep.ErrBadRequest
	}

	usr, err := h.svc.Create(c, veep.User{
		Username:   r.Username,
		Password:   r.Password,
		Email:      r.Email,
