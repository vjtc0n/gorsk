...
func TestAuthenticate(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (*veep.User, error) {
		...
		},
		{
			...
			jwt: &mock.JWT{
				GenerateTokenFn: func(u *veep.User) (string, string, error) {
...
func TestRefresh(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByTokenFn: func(db orm.DB, token string) (*veep.User, error) {
					return nil, veep.ErrGeneric
				},
			},
		},
